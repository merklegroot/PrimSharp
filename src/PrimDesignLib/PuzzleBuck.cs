...
namespace PrimDesignLib
{
    public class PuzzleBuck : Prim
    {
        public override string Render()
        {
            ...
            const decimal CutoutBreadth = 37.8m;
            const decimal WallThickness = 2.0m;
            const decimal FloorThickness = 1.25m;
            const decimal BumperBreadth = 48;

            const decimal HorizontalCutoutBreadth = 15;
            const decimal HorizontalCutoutHeight = 7.5m;
            ...
            var boxWithHorizontalCutout = box.Subtract(horizontalCutout.TranslateZ(box.Height / 2 - horizontalCutout.Height / 2));
